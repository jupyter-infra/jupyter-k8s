...
func (in *IdleShutdownConfig) DeepCopyInto(out *IdleShutdownConfig) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IdleShutdownConfig.
func (in *IdleShutdownConfig) DeepCopy() *IdleShutdownConfig {
	if in == nil {
		return nil
	}
	out := new(IdleShutdownConfig)
	in.DeepCopyInto(out)
	return out
}
