...
3. If the token is within the refresh window, it re-checks authorization via [`ConnectionAccessReview`](../../concepts/connections/access-review) and issues a refreshed token.
